...
var _preact2 = __webpack_require__(8);
...
var _PREACT_ENTRYPOINT__ = __webpack_require__(5);

Object.defineProperty(exports, 'default', {
  enumerable: true,
  get: function get() {
    return _interopRequireDefault(_PREACT_ENTRYPOINT__).default;
  }
});
...
if (typeof window !== 'undefined' && window.document && window.document.createElement) {
  ...
  var init = function init() {
    var RootComponent = __webpack_require__(5).default;
    root = (0, _preact.render)((0, _preact.h)(RootComponent), document.body, root);
  };

  if (false) {
    require('preact/devtools');
    module.hot.accept('__PREACT_ENTRYPOINT__', function () {
...
var jsxstyleDefaults = __webpack_require__(21);
...
function makePreactStyleComponentClass(displayName, defaultProps, tagName) {
  tagName = tagName || 'div';
  invariant(typeof displayName === 'string' && displayName !== '', 'makePreactStyleComponentClass expects param 1 to be a valid displayName');
  ...
  var Style = function (_Component) {
    ...
    function Style(props) {
      ...
      _this.className = getClassName(props, props.class);
      return _this;
    }
    ...
    _createClass(Style, [{
      ...
      value: function render(_ref) {
        ...
        return h(this.component, _extends({}, props, {
...
var getStyleKeysForProps = __webpack_require__(16);
var addStyleToHead = __webpack_require__(19);
var stringHash = __webpack_require__(20);
...
var dangerousStyleValue = __webpack_require__(18);
